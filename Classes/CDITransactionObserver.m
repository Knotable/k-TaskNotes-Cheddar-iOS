	...
	for (SKPaymentTransaction *transaction in transactions) {
		...
		[[CDKHTTPClient sharedClient] postPath:@"receipts" parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
			...
			dispatch_async(dispatch_get_main_queue(), ^{
				...
				UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Tasknote Plus" message:@"Thanks for upgrading to Cheddar Plus. Enjoy!" delegate:nil cancelButtonTitle:@"I'm Awesome" otherButtonTitles:nil];
				[alert show];
			});
