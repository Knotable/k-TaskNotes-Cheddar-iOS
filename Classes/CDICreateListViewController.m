...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *leftButton = [[UIBarButtonItem alloc] initWithTitle:@"Cancel" style:UIBarButtonItemStyleDone target:self action:@selector(cancel:)];
    ...
    UIBarButtonItem *rightButton = [[UIBarButtonItem alloc] initWithTitle:(self.list ? @"Save" : @"Create") style:UIBarButtonItemStyleDone target:self action:@selector(create:)];
